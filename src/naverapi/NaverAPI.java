...
public class NaverAPI {
	public String searchNews(String str) {
		String[] code = util.readLineFile("C:/Users/pc/Desktop/javascript/app_info.txt").split("\\n");
//		String[] cArr = code.split("\\n");
	...
	public String searchBlog(String str) {
		String[] code = util.readLineFile("C:/Users/pc/Desktop/javascrip/app_info.txt").split("\\n");
//		String[] cArr = code.split("\\n");
...
//			System.out.println(dto.getPubDate());
	...
	public ArrayList<NaverApiDto> getListJson(int kidx, String responseBody) {
		// json 파싱
		Gson gson = new Gson();
		ArrayList<NaverApiDto> list = new ArrayList<NaverApiDto>();
//        NaverApiDto dto = gson.fromJson(responseBody, NaverApiDto.class);
